# AI PDF Chatbot & Agent Powered by LangChain and LangGraph
 ...
 An AI chatbot agent that ingests PDF documents, stores embeddings in a vector database (Supabase), and then answers user queries using OpenAI (or another LLM provider) utilising LangChain and LangGraph as orchestration frameworks.
